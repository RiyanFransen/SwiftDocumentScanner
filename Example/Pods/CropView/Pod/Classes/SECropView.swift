...
public class SECropView: UIView {
    ...
    public var cornersLocationOnView : [CGPoint]? {
        ...
        let x = (-cropViewOrigin.x + imageViewOrigin.x + imageOrigin.x + SECropView.cornerSize / 2.0)
		let y = (-cropViewOrigin.y + imageViewOrigin.y + imageOrigin.y + SECropView.cornerSize / 2.0)
        let shift = CGPoint(x: x, y: y)
